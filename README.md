...
> Here is our server: `<invite link>`. Open it and type your name. On iPhone, install the TestFlight invite I send you, or open the link in Safari and choose Share → Add to Home Screen. On Android, install the APK I send you. Tap a 🔊 voice channel to join the call. Lessons may be recorded for people who miss them; you always see a red "Recording" sign in the call when that happens. When the app asks about notifications, tap Turn on to hear when we write or start a call.
